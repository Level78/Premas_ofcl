      ...
      <Grid container spacing={4} direction={isMd ? 'row' : 'column-reverse'}>
        <Grid item xs={12} md={6} data-aos="fade-up">
          <SectionHeader
            title={
              <span>
               Current and emerging applications with higher efficiency and fewer restraints
                <Typography component="span" variant="inherit" color="primary">  Nextseq 2000</Typography>
                <br />
                <span></span>
              </span>
            }
            subtitle="Scale for the future while driving efficiencies today Innovative, scalable platform empowers deeper investigation, larger studies, and higher resolution on a benchtop system"
            align="left"
            disableGutter
          />
          <List disablePadding>
