...
//             </Grid> */}
            ...
            subtitle=  " Targeted Gene Expression. Reduce costs while scaling up experimental throughput or increasing sequencing depth with customizable, comprehensive gene panels."
            ctaGroup={[
      ...
      <Grid container spacing={isMd ? 4 : 2}>
        <Grid item xs={12} sm={6} data-aos={'fade-up'}>
          <DescriptionListIcon
            title="Pre-designed Panels"
            subtitle=" Hone in on gene expression relevant to your research area. Each panel consists of validated probes for over 1,000 genes"
            icon={
              <Icon
        ...
        <Grid item xs={12} sm={6} data-aos={'fade-up'}>
          <DescriptionListIcon
            title="Add on to Pre-designed Panels"
            subtitle=" Customize pre-designed panels and add up to 200 additional genes with the 10x Genomics Custom Panel Designer. Or, if you already have a specific set of genes you want to analyze, you can create those panel designs from scratch."
            icon={
              <Icon
                fontIconClass="fas fa-briefcase"
                size="medium"
        ...
        <Grid item xs={12} sm={6} data-aos={'fade-up'}>
          <DescriptionListIcon
            ...
            subtitle="If you’d like to start from scratch and tackle a different research area altogether, or you have a specific set of genes you want to analyze, the Custom Panel Designer will create those designs and help you get started."
            icon={
              <Icon
                fontIconClass="fas fa-briefcase"
                size="medium"
        ...
        >
          <Image
            src="https://ik.imagekit.io/j6phbjneuop/unnamed__5__nRIMrROEv.jpg"
            alt="targeted"
